...
/**
 * Created by luojiahuaguet@163.com on 2017/01/09.
 * * This file provides a general implementation of model inference with sparse features input. not just for dnn.
 */
public class DNNModelImp implements DLModel {
    ...
    /**
     *
     * @param input a hashmap containing the sparse values, indices and size of feature
    ...
    public <T> double predict(Object input, Class<T> inputType){
        ...
        try {
            ...
            Tensor result = session.runner()
                    //remember that, below names must be consistent to the export placeholders' names defined in the python training file
